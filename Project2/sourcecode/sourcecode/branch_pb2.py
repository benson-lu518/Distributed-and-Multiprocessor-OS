...
# source: project1_sourcecode/branch.proto
...
_MSGREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='type', full_name='MsgRequest.type', index=1,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='money', full_name='MsgRequest.money', index=3,
...
MsgRequest = _reflection.GeneratedProtocolMessageType('MsgRequest', (_message.Message,), {
  ...
  '__module__' : 'project1_sourcecode.branch_pb2'
